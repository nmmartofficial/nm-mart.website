...
import { MessageCircle, Send, X, ShoppingCart, SendHorizontal, Trash2, Bot } from 'lucide-react';
...
const ChatBot = ({ isOpen, setIsOpen }: ChatBotProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-md bg-card border border-border rounded-[32px] shadow-2xl flex flex-col h-[600px] max-h-[85vh] overflow-hidden animate-in zoom-in-95 fade-in duration-300">
