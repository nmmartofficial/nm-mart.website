...
const ProductSearch = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Isse aap "5 star" likhenge toh bhi "5 STAR" mil jayega (Smart Search)
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid gap-4 max-w-4xl mx-auto">
          {results.length > 0 ? results.map((item, index) => (
            ...
            <p className="opacity-30 italic text-white text-center">Item nahi mila. Sahi naam likhein.</p>
          )}
        </div>
      </div>
    </section>
