        ...
        <div className="flex h-[52px] items-center justify-between gap-2 md:h-[72px] md:gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2.5 md:gap-3 md:pl-1">
            ...
            <button
              ...
              className={`hidden h-11 items-center gap-2 rounded-full border border-white/30 px-4 text-[10px] font-black uppercase tracking-[0.18em] text-white shadow-sm transition md:order-4 md:inline-flex ${
