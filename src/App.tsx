...
<div className="flex items-center">
  {isLoggedIn ? (
    <div className="flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-full border border-white/20 mr-2 shadow-inner">
      <div className="w-5 h-5 bg-yellow-400 text-navy-900 rounded-full flex items-center justify-center text-[10px] font-black uppercase">
        {userName.charAt(0)}
      </div>
    ...
    <button 
      ...
      className="text-[10px] font-black bg-white/20 text-white px-4 py-1.5 rounded-full border border-white/30 hover:bg-yellow-400 hover:text-navy-900 transition-all mr-2 uppercase tracking-wider"
    >
      Login
    </button>
  )}
